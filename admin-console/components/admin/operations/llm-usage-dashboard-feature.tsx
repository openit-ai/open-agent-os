  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          <Button asChild variant="outline" size="sm">
            <Link href="/connections/harness/llm-runtime">
      ...
      <div className="flex gap-1 border-b" role="tablist" aria-label="providers tabs">
        <Link href="/connections/harness/llm-runtime" className="rounded-t-md px-3 py-1.5 text-sm text-muted-foreground hover:bg-accent hover:text-foreground" role="tab" aria-selected="false"><span className="inline-flex items-center gap-1"><Cpu className="h-3.5 w-3.5" />{t("nav.providers")}</span></Link>
