...
export function OperationsHealthFeature() {
  ...
  return (
    <div className="space-y-6">
      ...
      {loading ? <Skeleton variant="table" rows={5} /> : rows.length === 0 ? (
