  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Button asChild variant="outline" size="sm">
            <Link href="/operations/usage"><BarChart3 className="mr-1 h-4 w-4" />{t("providers.usageTab")}</Link>
          </Button>
      ...
      <div className="flex gap-1 border-b" role="tablist" aria-label="providers tabs">
        ...
        <Link href="/operations/usage" className="rounded-t-md px-3 py-1.5 text-sm text-muted-foreground hover:bg-accent hover:text-foreground" role="tab" aria-selected="false">{t("providers.usageTab")}</Link>
      </div>
