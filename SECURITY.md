...
| `v0.1.7` | ✅ | Current product — Source-Available (BSL 1.1, Change Date 2030-08-27 → Apache 2.0), product version `0.1.7` (arch `v1.7.4` distinct), release content: Phase 6 IA merge `983dc4c` + deploy/audit fixes `c68bf47` |
