# Open Agent OS 최종 아키텍처 및 구현 설계서 v1.7.3
...
> Version: **v1.7.3** — 2026-09-05 (v1.7.2 → v1.7.3 Control-Plane-centric IA aliases + canonical process names; product `0.1.5`)
...
**Residual**: 구 라벨 정리·사이드바 기본 전환·운영 롤아웃(enable/start 전환)은 별도 승인 후 다음 릴리스에서 수행한다.
